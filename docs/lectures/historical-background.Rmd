...
systemdata <- read_csv(here("../../../Data Files/COW Data/System/system2011.csv")) %>% 
  group_by(year) %>% 
  summarise(Countries = n_distinct(ccode, na.rm = TRUE)) %>% 
...
.pull-right[
<figure>
<img src="../../../media/thomas-jefferson.png" width="500" height="400" alt="Thomas Jefferson" style="position:relative;left:15px; top:-75px;">
