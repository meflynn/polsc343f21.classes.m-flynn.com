...
<figure>
<img src="../../../media/nato-exercise-2018.jpg" style="width:700px; height:400px">
...
<figure>
<img src="../../../media/us-military-exercise-korea.jpg" style="width:700px; height:400px">
...
<figure>
<img src="../../../media/beyond-the-horizon-vet.jpg" style="width:600px; height:400px;">
...
<img src="../../../media/guns-v-butter-1.png">


---
class: center, middle

<img src="../../../media/guns-v-butter-2.png">


---
class: center, middle

<img src="../../../media/guns-v-butter-3.png">
...
<img src="../../../media/allies-hub-and-spoke.png">
...
<img src="../../../media/allies-networked.png">
...
<img src = "../../../media/apsr-coefplot-screenshot.png" style="width:500px; height:500px;">
...
<img src = "../../../media/isq-coefplot-screenshot.png" style="width:500px; height:400px;">
...
```{r japan economy map}
#country.df <- ms_simplify(japan.map, keep = 0.1, keep_shapes = TRUE)
country.df <- tidy(japan.map, region = "name") %>% 
  arrange(order) %>% 
...
combined = country.df %>% 
  left_join(opinion, by = "provcode") %>% 
  arrange(order)


# National economic assessment
plot.nat <- ggplot(data = combined, aes(x = long, y = lat, fill = econ_nat_perc, group = group)) +
  ...
  scale_fill_distiller(palette = "Spectral", type = "seq", direction = 1, label = percent_format()) 


# Local economic assessment
plot.loc <- ggplot(data = combined, aes(x = long, y = lat, fill = econ_loc_perc, group = group)) +
...
ggarrange(plot.nat, plot.loc, ncol = 2, common.legend = TRUE, legend = "bottom")
...
<figure>
<img src="../../../media/okinawan-protest-pic.jpg" style="width:600px; height:350px;">
...
ggplot(data = combined, aes(x = long, y = lat, fill = troops_crime_perc, group = group)) +
  geom_polygon(colour = "black", size = .1) +
  coord_map(projection = "mercator") +
  theme_void() +
  theme(legend.position = c(0.9, 0.5),
...
ggplot() +
  geom_polygon(data = combined, aes(x = long, y = lat, fill = troops_crime_perc, group = group), colour = "black", size = .1) +
  geom_point(data = base.data %>% filter(Country.Name == "Japan"), aes(x = Longitude, y = Latitude), color = "red", size = 3, alpha = .5) +
  coord_map(projection = "mercator") +
  theme_void() +
  theme(legend.position = c(0.9, 0.5),
        legend.key.width = unit(1, "cm"),
  ...
  labs(fill = "Percent Positive",
       title = "Impact on crime") +
  scale_fill_distiller(palette = "Blues", type = "seq", direction = -1, label = percent_format())
