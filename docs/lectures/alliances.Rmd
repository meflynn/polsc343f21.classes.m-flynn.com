...
theme_flynn <- function(){ 
      ...
      theme_linedraw(base_size = 12, base_family = "Arial") %+replace% 
        ...
        theme(plot.title = element_markdown(face = "bold", size = 20, hjust = 0, margin = margin(t = 0, b = 0.3, l = 0, r = 0, unit = "cm")),
              plot.subtitle = element_markdown(size = 14, face = "italic", color = "gray50", lineheight = 0.2, hjust = 0),
              plot.caption = element_markdown(face = "italic", size = 8, hjust = 0, lineheight = 0.5), 
...
<img src="../../../media/alliance-model-1.png">
...
.pull-right[
<img src="../../../media/trump-nato-summit.jpg" style="height:270px; width:400px;">
]
...
.pull-right[
<img src="../../../media/saceur.jpg" style="width:300px; height:400px;">
]
...
.pull-right[
<img src="../../../media/lord-ismay.jpg" style="width:300px; height:400px; left:75px;">
]
...
.pull-right[
<img src="../../../media/ford-park-picture.jpg" style="width:400px; height:300px">
]
