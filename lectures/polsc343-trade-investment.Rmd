...
<img src="../../../media/hiscox-1999-figure.png" style="width:650px; height:850px; left:180px; top:-150px;">
...
ggplot(data = subset(us.trade.gdp, name == "Exports" | name == "Imports"), aes(x = year, y = value, group = name, colour = name)) +
  geom_line(size = 2) +
  theme_flynn +
  labs(x = "Year",
       y = "",
...
<figure>
<img src="../../../media/fdr-ibn-al-saud.jpg" style="width:600px; height:400x;">
...
<img src="../../../media/trade-importance-figure.png" style="width:800px; height:500x;">
